...
data_root = '/autodl-fs/data/data/nuscenes/v1.0-mini/'
...
data = dict(
    ...
    test=dict(type=dataset_type, pipeline=test_pipeline, collect_keys=collect_keys + ['img', 'img_metas'], queue_length=queue_length, ann_file=data_root + 'nuscenes_infos_val.pkl', classes=class_names, modality=input_modality),
